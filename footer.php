    ...
    <footer class="bg-white text-brand-text border-t border-gray-200">
        <div class="container mx-auto px-6 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <a href="index.php"><img src="obrazky/logo.jpg" alt="Logo Laboratoires" class="h-10 w-auto mb-4"></a>
                    <p class="text-gray-600">Chytré doplňky stravy pro moderní životní styl.</p>
                </div>
                <div>
                    <h4 class="text-lg font-bold mb-4">Navigace</h4>
                    <ul class="space-y-2 text-gray-600">
                        <li><a href="produkty.php" class="hover:text-brand-primary transition-colors">Produkty</a></li>
                        <li><a href="o-nas.php" class="hover:text-brand-primary transition-colors">O nás</a></li>
                        <li><a href="kontakt.php" class="hover:text-brand-primary transition-colors">Kontakt</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-lg font-bold mb-4">Informace</h4>
                    <ul class="space-y-2 text-gray-600">
                        <li><a href="obchodni-podminky.php" class="hover:text-brand-primary transition-colors">Obchodní podmínky</a></li>
                        <li><a href="ochrana-udaju.php" class="hover:text-brand-primary transition-colors">Ochrana osobních údajů</a></li>
